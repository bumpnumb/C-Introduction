        ...
        public static string GenerateJumpNameFromCode(string code)
        {
            ...
            else if (chars[0] == "5")
            {
                ...
                if (chars[1] == "2")
                {
                    ...
                    else if (chars[2] == "7")
                    {
                        ...
                        if (chars[3] == "1")
                        {
                            CodeString += "1/2 Twist";  //5271
                        }
                        else if (chars[3] == "3")
                        {
                            CodeString += "1 1/2 Twists";   //5273
                        }
                        else if (chars[3] == "5")
                        {
                            CodeString += "2 1/2 Twists";   //5275
                        }
                    }
                }
                else if (chars[1] == "3")
            ...
            else if (chars[0] == "6")
            {
                ...
                else if (chars[1] == "3")
                {
                    ...
                    if (chars[2] == "1")
                    {
                        CodeString += "1/2 Somersault";     //631
                    }
                    else if (chars[2] == "2")
                    {
                        CodeString += "1 Somersault";   //632
                    }
                    else if (chars[2] == "3")
                    {
                        CodeString += "1 1/2 Somersaults";  //633
                    }
                    else if (chars[2] == "4")
                    {
                        CodeString += "2 Somersaults";  //634
                    }
                    else if (chars[2] == "6")
                    {
                        CodeString += "3 Somersaults";  //636
                    }
                    else if (chars[2] == "8")
                    {
                        CodeString += "4 Somersaults";  //638
                    }
                }
            }
            CodeString += " " + last;
