...
namespace Client.services
{
    ...
    class ClientControll
    {
        ...
        public static void Listen(object obj)
        {
            ...
            // En alternativ lösning man kan köra här nedanför, kollar på den senare (snyggare lösning än mitt fulhack där uppe)
            ...
            /*if (Stream.CanRead)
            {
                ...
                do
                {
                    ...
                    msg.AppendFormat("{0}", Encoding.ASCII.GetString(myReadBuffer, 0, numberOfBytesRead));

                }
                while (Stream.DataAvailable);

                // Print out the received message to the console.
                Console.WriteLine("You received the following message : " + msg);
                Response rsp = JsonConvert.DeserializeObject<Response>(msg); (Json kan inte konvertera från stringbuilder) går att använda .ToString() istället
                rsp.HandleResponse();
    ...
    // below is legacy code. even though its better.
